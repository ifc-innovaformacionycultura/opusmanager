// Papeles predefinidos del archivo musical (espejo de /app/backend/papeles_archivo.py).
// Reutilizado por GestorArchivo.js y por la verificación de atriles en eventos.

export const PAPELES_ARCHIVO = {
  // CUERDA
...
export const PAPELES_POR_SECCION = {
